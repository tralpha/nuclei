        ...
        for inputs, truth_boxes, truth_labels, truth_instances, metas, indices in train_loader:
            ...
            if 0:
                ...
                for b in range(batch_size):
                    ...
                    all5 = draw_multi_proposal_metric(
                        cfg, image, rpn_proposal, truth_box, truth_label,
                        [0, 255, 255], [255, 0, 255], [255, 255, 0])
                    all6 = draw_multi_proposal_metric(
                        cfg, image, rcnn_proposal, truth_box, truth_label,
                        [0, 255, 255], [255, 0, 255], [255, 255, 0])
                    all7 = draw_mask_metric(cfg, image, mask, truth_box,
                                            truth_label, truth_instance)
                    ...
                    cv2.imwrite(out_dir + '/train/%05d.rpn_precision.png' % b,
                                all5)
                    cv2.imwrite(
                        out_dir + '/train/%05d.rcnn_precision..png' % b, all6)
                    cv2.waitKey(1)
                    pass
